    ...
    begin
      ...
      vm_file_paths.each do |vm_file_path|
        ...
        while parser.has_more_commands?
          ...
          elsif parser.command_type == Parser::COMMAND_TYPES[:C_LABEL]
            code_writer.write_label(parser.arg1)
          elsif parser.command_type == Parser::COMMAND_TYPES[:C_GOTO]
            code_writer.write_goto(parser.arg1)
          elsif parser.command_type == Parser::COMMAND_TYPES[:C_IF_GOTO]
            code_writer.write_if_goto(parser.arg1)
          elsif parser.command_type == Parser::COMMAND_TYPES[:C_FUNCTION]
            code_writer.write_function(parser.arg1, parser.arg2)
          elsif parser.command_type == Parser::COMMAND_TYPES[:C_CALL]
            code_writer.write_call(parser.arg1, parser.arg2)
          elsif parser.command_type == Parser::COMMAND_TYPES[:C_RETURN]
